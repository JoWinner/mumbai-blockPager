class SimpleImg {
  ...
  constructor({ data, api }) {
    ...
    this.settings = [
      ...
      {
        name: "withBackground",
        icon: `<svg width="30" height="30" viewBox="0 0 20 20" class="text-sky-500 stroke-none" xmlns="http://www.w3.org/2000/svg">
  ...
  render() {
    ...
    input.placeholder = "Only paste image URL here/ Drag & drop image anywhere";
    input.setAttribute("class", "link-field");
