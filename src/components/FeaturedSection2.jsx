...
const FeaturedSection2 = ({ featuredPagers, featuredPager }) => {
  return (
    <div className="px-10 my-16 text-black grid grid-cols-12 gap-y-6 md:gap-4">
      <div className="flex flex-col justify-between col-span-12 py-2 space-y-8 md:space-y-10 md:col-span-5 lg:col-span-4 xl:col-span-3 md:h-96 h-96">
      ...
      <div className=" py-1 col-span-12  lg:col-span-3  lg:block">
        <div className="flex flex-col text-white h-96 px-1 flex-no-wrap overflow-y-scroll scrolling-touch divide-y custom-scroll scroll-smooth space-y-2">
          {featuredPagers.map((content) => (
            <div
